...
output_dir="/storage/brno12-cerit/home/alena_bartonova/RAD_Paph_Lim/trimmomatic_4bpcut"

for pool in /storage/brno12-cerit/home/alena_bartonova/RAD_Paph_Lim/Trimmomatic_adaptercut/*_1.paired.fq.gz; do
    echo $pool
    pool_name=$(basename "$pool" _1.paired.fq.gz)
